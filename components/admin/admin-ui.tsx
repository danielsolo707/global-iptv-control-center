...
export function StatusBadge({ status }: { status: ChannelAdminStatus }) {
  const styles: Record<ChannelAdminStatus, string> = { online: "bg-emerald-500/10 text-emerald-500", offline: "bg-red-500/10 text-red-500", blocked: "bg-amber-500/10 text-amber-500", removed: "bg-muted text-muted-foreground", disabled: "bg-purple/10 text-purple" }
